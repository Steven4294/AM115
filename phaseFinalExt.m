...
for C_2=0:5:200
  ...
  for C_1=0:5:200
    ...
    dV_2=(alpha - a)*V_2*(1 - V_2/(k - M_2)) - D_4*V_2*(M_1^2 / (B_4 + M_1^2))*(M_2 / (A_4 + M_2^2));
    dM_2(i,j)=a*V_2*(1 - V_2/(k - V_2)) -D_3*M_2*(M_1^2 / (B_3 + M_1^2))*(M_2 / (A_3 + M_2^3));
    dC_2=dV_2+dM_2;
  end
end
